export default function SearchCategories() {
  return (
    <form
      action="#"
      className="bg-on-primary shadow-lg tablet:flex-row tablet:justify-between tablet:items-center tablet:max-w-7/10 mx-auto mt-10 flex w-full max-w-9/10 flex-col items-start gap-y-10 rounded-4xl px-2 py-3 lg:max-w-3xl"
    >
